...
export default function OnlineScreen2({
  route,
  navigation,
  ...
  const idcompleto = route.params;
  const id = idcompleto!.idgame;
  console.log("id", id);
    ...
    >
      ...
      >
        {generateMap(gameStage, (i, j) => {
          ...
          if (winnerSymbol || gameStage[i][j] || turnSymbol !== X_SYMBOL) {
